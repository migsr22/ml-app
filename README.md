...
```
"# py_web"  git init git add README.md git commit -m "first commit" git branch -M master git remote add origin https://github.com/migsr22/py_web.git git push -u origin master
"# py_web" 
